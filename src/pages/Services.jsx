...
const services = [
  {
    icon: '🎬', title: 'SaaS Video',
    desc: 'Engaging videos to showcase your SaaS products and drive conversions.',
    tags: ['SaaS', 'Video'],
    color: 'from-violet-500/20 to-purple-500/10',
    portfolioTab: 'animation', portfolioCat: 'saas_anim',
  },
  {
    icon: '🎨', title: '2D Animation',
    desc: 'Bring ideas to life with high-quality 2D animations that captivate your audience.',
    tags: ['2D', 'Animation'],
    color: 'from-pink-500/20 to-rose-500/10',
    portfolioTab: 'animation', portfolioCat: 'explainer2d',
  },
  {
    icon: '💻', title: 'Web Development',
    desc: 'Custom, performant, and scalable web applications on any platform.',
    tags: ['React', 'Next.js', 'Custom'],
    color: 'from-blue-500/20 to-cyan-500/10',
    portfolioTab: 'websites', portfolioCat: 'all',
  },
  {
    icon: '✂️', title: 'Video Editing',
    desc: 'Professional video editing and post-production for all platforms.',
    tags: ['Editing', 'Post-Production'],
    color: 'from-amber-500/20 to-orange-500/10',
    portfolioTab: 'animation', portfolioCat: 'videoediting',
  },
  {
    icon: '✨', title: 'Brand Identity & Graphic Design',
    desc: 'Stand out with a memorable brand identity that resonates with your audience.',
    tags: ['Branding', 'Graphics'],
    color: 'from-emerald-500/20 to-green-500/10',
    portfolioTab: 'design', portfolioCat: 'branding',
  },
  {
    icon: '📝', title: 'Story Boarding & Script Development',
    desc: 'Compelling narratives and visual storyboards for any creative medium.',
    tags: ['Script', 'Story'],
    color: 'from-teal-500/20 to-cyan-500/10',
    portfolioTab: 'animation', portfolioCat: 'showreel',
  },
  {
    icon: '🤖', title: 'AI Powered Creative Production',
    desc: 'Cutting-edge AI tools for fast, creative content at unprecedented scale.',
    tags: ['AI', 'Creative'],
    color: 'from-indigo-500/20 to-blue-500/10',
    portfolioTab: 'websites', portfolioCat: 'aiapp',
  },
  {
    icon: '📱', title: 'Social Media Creative Content',
    desc: 'Scroll-stopping content that grabs attention in crowded feeds.',
    tags: ['Social Media', 'Content'],
    color: 'from-fuchsia-500/20 to-pink-500/10',
    portfolioTab: 'design', portfolioCat: 'socialmedia',
  },
  {
    icon: '👁️', title: 'Visual Solutions',
    desc: 'Comprehensive visual strategies that differentiate your brand.',
    tags: ['Visuals', 'Strategy'],
    color: 'from-sky-500/20 to-blue-500/10',
    portfolioTab: 'design', portfolioCat: 'illustrations',
  },
  {
    icon: '📈', title: 'Social Media Marketing',
    desc: 'Data-driven social media marketing to amplify your reach.',
    tags: ['Marketing', 'Social'],
    color: 'from-lime-500/20 to-green-500/10',
    portfolioTab: 'design', portfolioCat: 'socialmedia',
  },
  {
    icon: '🔍', title: 'Search Engine Optimization',
    desc: 'Search Engine Optimization strategies to dominate rankings.',
    tags: ['SEO', 'Ranking'],
    ...
    <div className="pt-20 pb-32 overflow-hidden">
      ...
      <section className="relative py-20 md:py-28 text-center overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-0 right-0 w-96 h-96 rounded-full bg-gradient-to-br from-primary/8 to-secondary/5 blur-[100px] pointer-events-none"
        />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial="hidden" animate="visible" className="max-w-3xl mx-auto">
            ...
            <motion.div variants={fadeInUp} custom={3} className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((srv, idx) => (
            ...
            >
              <Link
                to={`/portfolio?tab=${srv.portfolioTab}${srv.portfolioCat !== 'all' ? `&cat=${srv.portfolioCat}` : ''}`}
              ...
              >
                <div className="glass-card p-8 h-full relative overflow-hidden transition-all duration-500 hover:border-primary/30 hover:-translate-y-2 hover:shadow-[0_20px_60px_-15px_rgba(99,102,241,0.2)] cursor-pointer">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-textMuted mb-5 text-sm leading-relaxed">{srv.desc}</p>
                    ...
                    <div className="flex items-center gap-1 text-xs text-primary/60 group-hover:text-primary transition-colors duration-300">
          ...
          <div className="space-y-16">
            {processSteps.map((item, i) => (
              ...
              >
                ...
                {/* Content */}
                <div className={`glass-card p-6 md:p-8 md:w-[calc(50%-3rem)] ${i % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-32 text-center">
        ...
        >
          ...
          <p className="text-textMuted mb-8 relative z-10">
            Tell us what you're building — we'll recommend the right approach and give you a straight answer on timeline and cost.
          </p>
