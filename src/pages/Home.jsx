...
/* ─── Services data ─── */
const services = [
  { title: "SaaS Video", icon: "🎬", desc: "Engaging videos to showcase your SaaS products and drive conversions." },
  { title: "2D Animation", icon: "🎨", desc: "Bring ideas to life with high-quality 2D animations that captivate." },
  { title: "Web Dev", icon: "💻", desc: "Custom, performant, and scalable web applications on any platform." },
  { title: "Video Editing", icon: "✂️", desc: "Professional video editing and post-production for all platforms." },
  { title: "Brand Identity", icon: "✨", desc: "Stand out with a memorable brand identity and graphic design." },
  { title: "Script & Storyboard", icon: "📝", desc: "Compelling narratives and visual storyboards for any medium." },
  { title: "AI Creative Production", icon: "🤖", desc: "Cutting-edge AI tools for fast, creative content at scale." },
  { title: "Social Media Content", icon: "📱", desc: "Scroll-stopping content designed for your social feeds." },
  { title: "Visual Solutions", icon: "👁️", desc: "Comprehensive visual strategies that elevate your brand." },
  { title: "SMM", icon: "📈", desc: "Social Media Marketing strategies to amplify your reach." },
  { title: "SEO", icon: "🔍", desc: "Search Engine Optimization to dominate search rankings." }
];
...
export default function Home() {
  ...
  // Smoother scroll transforms with spring physics
  ...
  /* Word-by-word animation for hero heading */
